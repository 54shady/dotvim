...
hi ErrorMsg term=standout ctermbg=Black ctermfg=White guibg=Black guifg=White
...
hi WarningMsg term=standout ctermfg=Black guifg=Red
...
hi Constant term=underline ctermfg=Black guifg=Magenta guibg=grey95
